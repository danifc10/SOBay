...
item* adicionaItem(item *i,int *tam,  char *n, int id, char *ctg, int vb, int cj, int tmp, char *, char *, int);
item *leFicheiroItem(char *nomeFich, item *i, int *);
item * eliminaItem(int id, item *i, int *item_len);
int compraItem(item *i, int id, int valor, char *,  int saldo, int *item_len);
void atualizaFitems(item *i, int tam, char *nome, int);
#endif
